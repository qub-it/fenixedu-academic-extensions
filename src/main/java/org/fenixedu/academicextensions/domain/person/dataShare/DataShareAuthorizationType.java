...
public class DataShareAuthorizationType extends DataShareAuthorizationType_Base {
    ...
    @Atomic
    public DataShareAuthorizationType edit(final String code, final LocalizedString name, final Set<Profile> profiles,
            final boolean active, final LocalizedString question) {

        this.init(code, name, active, question);
        addAutoGeneratedProfileToProfiles(profiles);
    ...
    public void addAutoGeneratedProfileToProfiles(Set<Profile> profiles) {
        getIdentifierAccessControlProfile().ifPresent(
                autoGeneratedProfile -> profiles.forEach(p -> p.addChildProfile(autoGeneratedProfile)));
    }
