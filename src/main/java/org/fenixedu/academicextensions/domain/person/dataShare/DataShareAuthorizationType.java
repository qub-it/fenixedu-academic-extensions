...
public class DataShareAuthorizationType extends DataShareAuthorizationType_Base {
    ...
    @Atomic
    public static DataShareAuthorizationType create(final String code, final LocalizedString name, final Profile profile,
            final boolean active, final LocalizedString question) {
        final DataShareAuthorizationType result = new DataShareAuthorizationType();
        result.init(code, name, active, question);
        result.initAccessControlProfile(profile);
        return result;
    }
    ...
    private void initAccessControlProfile(Profile profile) {
        String profileCode = getCode() + ":" + UUID.randomUUID();
        com.qubit.terra.framework.tools.primitives.LocalizedString profileName =
                new com.qubit.terra.framework.tools.primitives.LocalizedString().with(getCode() + " - " + getName());
        ...
        profile.addChildProfile(autoGeneratedProfile);
    }
}
